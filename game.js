// game.js - 移除牛油果，适配触屏操作，使用 375x812 尺寸
...
function drawBackground() {
    if (gameImages.background && gameImages.background.complete) {
        // 使用新的 canvas.width 和 canvas.height (375x812) 绘制背景
...
function spawnFruit() {
    ...
    // 随机 X 轴位置，范围是 0 到 375 - fruitWidth
